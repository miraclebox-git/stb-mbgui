...
def InitUsageConfig():
	...
	config.usage.serviceitems_per_page = ConfigSelectionNumber(default = 13, stepwidth = 1, min = 8, max = 40, wraparound = True)
	...
	config.osd.dst_left = ConfigSelectionNumber(default = 14, stepwidth = 1, min = 0, max = 720, wraparound = False)
	config.osd.dst_width = ConfigSelectionNumber(default = 693, stepwidth = 1, min = 0, max = 720, wraparound = False)
	config.osd.dst_top = ConfigSelectionNumber(default = 12, stepwidth = 1, min = 0, max = 576, wraparound = False)
	config.osd.dst_height = ConfigSelectionNumber(default = 552, stepwidth = 1, min = 0, max = 576, wraparound = False)
	...
	config.timeshift.favoriteSaveAction = ConfigSelection([("noSave", _("Ask user")),("savetimeshift", _("Save and stop")),("savetimeshiftandrecord", _("Save and record")),("noSave", _("Don't save"))], "askuser")
	...
	crashlogheader = _("We are really sorry. Your receiver encountered " \
					 ...
					 "Please send the logfile %senigma2_crash_xxxxxx.log to dev@miraclebox.se.\n" \
	...
	config.epgselection.enhanced_itemsperpage = ConfigSelectionNumber(default = 18, stepwidth = 1, min = 8, max = 40, wraparound = True)
